      ...
      <div class="overflow-x-auto">
        <table class="$1$2">
          <thead class="bg-secondary">
            <tr>
              <th class="whitespace-normal break-words  px-6 py-3 text-left text-xs font-semibold text-white uppercase tracking-wider border-b">Nama Pemasok</th>
              <th class=" px-6 py-3 text-left text-xs font-semibold text-white uppercase tracking-wider border-b">Email</th>
              <th class=" px-6 py-3 text-left text-xs font-semibold text-white uppercase tracking-wider border-b">No. Telepon</th>
              <th class=" px-6 py-3 text-left text-xs font-semibold text-white uppercase tracking-wider border-b">Alamat</th>
          ...
          <tbody class="bg-white">
            ...
            >
              <td class="whitespace-normal break-words px-6 py-4 font-medium text-gray-900 border-t truncate" :title="supplier.name">{{ supplier.name }}</td>
